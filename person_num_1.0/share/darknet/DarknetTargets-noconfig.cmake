...
set_target_properties(Darknet::dark PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "/media/D/train_code/darknet-master/libdark.so"
  IMPORTED_SONAME_NOCONFIG "libdark.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS Darknet::dark )
list(APPEND _IMPORT_CHECK_FILES_FOR_Darknet::dark "/media/D/train_code/darknet-master/libdark.so" )
